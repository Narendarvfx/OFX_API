...
var bid_yValues = [];
        ...
        var bid_xValues = ["PAINT", "ROTO", "ROTOMATION", "CAMERATRACK", "COMP"];

        var bid_barColors = ["#055ff1", "#ef4305", "#05e7ef", "#ee09c8", "#05fd09"];
        var actual_barColors = ["#1e5bc4", "#e85d29", "#2ab6bb", "#853b77", "#05fd09"];

        var bid_canvas = document.getElementById("bidChart");
        var bid_ctx = bid_canvas.getContext('2d');
        var bid_chartType = 'bar';
        var bid_BarChart;
        ...
        var bid_data = {
            ...
            },
            {
                ...
                fill: true,
                lineTension: 0.1,
                backgroundColor: actual_barColors,
                borderCapStyle: 'square',
                pointBorderColor: "white",
                pointBackgroundColor: "green",
                pointBorderWidth: 1,
        ...
        function init() {
            ...
            bid_yValues.push(10,50,65,25,30)
            actual_yValues.push(12,35,73,32,40)
            // Chart declaration:
            bid_myBarChart = new Chart(bid_ctx, {
                type: bid_chartType,
                data: bid_data,
                options: bid_options
            });
