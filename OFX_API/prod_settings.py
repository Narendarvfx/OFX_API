...
if DEBUG:
    ...
    CHANNEL_LAYERS = {
        'default': {
            ...
            'CONFIG': {
                "hosts": [(config('CL_HOST', cast=str), config('CL_PORT', cast=str))],
            },
        },
    }
...
# else:
#     ### AWS STORAGE ####
#     AWS_ACCESS_KEY_ID = 'AKIA5EDY7UCE3LIPSB6D'
#     AWS_SECRET_ACCESS_KEY = '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'
#     AWS_STORAGE_BUCKET_NAME = 'shotbuzz-dev'
#     AWS_S3_CUSTOM_DOMAIN = 'shotbuzz-dev.s3.ap-south-1.amazonaws.com'
...
LOGIN_URL = '/login/'
LOGIN_EXEMPT_URLS = (
r'^admin/', r'^api/*', r'^media/', r'^profile/login_custom', r'^accounts/', r'^docs/', r'^health_check/',r'^api/user/password_change/')
